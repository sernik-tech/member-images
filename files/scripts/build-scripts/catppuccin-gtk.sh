...
mkdir -p /tmp/catppuccin-gtk/etc/skel/.local/share/themes
...
./install.sh -d /tmp/catppuccin-gtk/etc/skel/.local/share/themes -c dark -t green -s compact --tweaks catppuccin black
./install.sh -d /tmp/catppuccin-gtk/etc/skel/.local/share/themes -c light -t green -s compact --tweaks catppuccin
