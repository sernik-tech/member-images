...
# throttled
wget "https://copr.fedorainfracloud.org/coprs/abn/throttled/repo/fedora-$(rpm -E %fedora)/abn-throttled-fedora-$(rpm -E %fedora).repo" -O "/etc/yum.repos.d/_copr_abn-throttled.repo"
...
sed -i 's@enabled=1@enabled=0@g' /etc/yum.repos.d/_copr_abn-throttled.repo
